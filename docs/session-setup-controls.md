...
| ----------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Codex CLI and compatible local desktop runtime: Skill | A standalone Installation and ordered `skills.config` entries in user `config.toml`                                                                                                  | Exact Skill path, one harness. User configuration can affect other projects. The existing profile does not authorize project Skill rules.                                                      |
